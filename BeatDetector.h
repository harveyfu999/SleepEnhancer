...
#define BEATDETECTOR_MIN_THRESHOLD               1000      // minimum threshold (filtered) value
#define BEATDETECTOR_MAX_THRESHOLD               6000     // maximum threshold (filtered) value
#define BEATDETECTOR_STEP_RESILIENCY             100      // maximum negative jump that triggers the beat edge
